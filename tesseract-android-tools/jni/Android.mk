...
TESSERACT_PATH := ~/tesseract-android-tools/tesseract-android-tools/external/tesseract-3.00
LEPTONICA_PATH := ~/tesseract-android-tools/tesseract-android-tools/external/leptonica-1.68
LIBJPEG_PATH := ~/tesseract-android-tools/tesseract-android-tools/external/jpeg/6b/jpeg
